...
import { ReadInteractId } from "@/services/interact.routes";
...
const Diagram = ({ chart, id }) => {
  ...
  const getData = async () => {
    ...
    const response = await ReadInteractId(id);
  ...
  const exportToPDF = async () => {
    ...
    img.onload = () => {
      ...
      pdf.save(`mapa-conceptual-${data.cedula}-${data.fecha}.pdf`);
    };
  };

  return (
    <div className="w-full text-center">
      <div ref={diagramRef} className="my-10 flex justify-center">
        {imageURL ? (
